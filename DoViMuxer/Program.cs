...
namespace DoViMuxer
{
    ...
    internal partial class Program
    {
        ...
        private async static Task DoWorkAsync(MyOption option)
        {
            ...
            await Utils.RunCommandAsync(config.FFmpeg, $"-nostdin -loglevel warning -i \"{vTrack.FilePath}\" -c copy -bsf:v {(vTrack.H264 ? "h264_mp4toannexb" : "hevc_mp4toannexb")} -f {videoExt} \"{now}.{videoExt}\"", option.Debug);
